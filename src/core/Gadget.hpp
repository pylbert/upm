...
#define DEBUG_MSG(msg) do {} while (0)
     ...
     */
    typedef std::string (*t_getJson)(Gadget*);
    ...
    class Gadget
    {
        ...
        protected:
             ...
             */
            std::map<t_getJson, Gadget*> _child_value_serializers;

            /**
             * Used by child classes for child-to-parent proxy call
             */
            std::map<t_getJson, Gadget*> _child_json_deserializers;

            ///*
            //friend std::ostream& operator<<(std::ostream& os, const Gadget& o)
            //{
