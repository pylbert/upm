...
void ServoController::AngleAll (float angle)
{
...
void ServoController::AngleForCommand (float angle, std::string command)
{
...
void ServoController::AngleFromJson(std::string json_commands)
{
...
std::string ServoController::_DeserializeAngleCommands (Gadget * inst)
{
    /* Downcast to reference (throws if cast fails) */
    ServoController& ref = dynamic_cast<ServoController&>(*inst);
    ...
    /* Add all commands to Sensor's command vector */
