...
class ES08A : public virtual upm::ServoController
{
public:
...
class ServoController_unit : public ::testing::Test
{
protected:
    ServoController_unit() {}
    virtual ~ServoController_unit() {}
    virtual void SetUp()
    {
...
TEST_F(ServoController_unit, test_ServoController_basic)
{
    ASSERT_EQ(2, sref.Commands().size());
}

TEST_F(ServoController_unit, test_ServoController_serialize_command)
{
...
TEST_F(ServoController_unit, test_ServoController_deserialize_command)
{
    json jcmd = "{\"command\":\"axis0\",\"unit\":\"degrees\",\"value\":30.0}"_json;
    upm::ActuatorCommand<float> acmd = jcmd;
}

TEST_F(ServoController_unit, test_ServoController_run_command)
{
...
TEST_F(ServoController_unit, test_ServoController_run_command_invalid_command)
{
    ASSERT_THROW(sref.AngleFromJson("{\"command\":\"axis_doesn't_exist\",\"unit\":\"radians\",\"value\":3.14159}"),
                 std::invalid_argument);
}

TEST_F(ServoController_unit, test_ServoController_run_command_fail_deserialization)
{
    ASSERT_THROW(sref.AngleFromJson("This is not }{ a valid JSON string"),
                 std::invalid_argument);
}

TEST_F(ServoController_unit, test_ServoController_run_commands)
{
